...
<body>
    ...
    <div class="contenedor">
        ...
        <form class="formulario" method="POST" action="includes/tabla2/delete.php">

            <div class="campo">
                <label class="campo_label" for="idTB2">ID:  </label>
                <input class="campo_field" name="idTB2" type="text" placeholder="Id a eliminar" id="idTB2">
            </div>
