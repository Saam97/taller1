...
<body>
    ...
    <div class="contenedor">
        ...
        <form class="formulario" method="POST" action="includes/tabla2/editar.php">

            <div class="campo">
                <label class="campo_label" for="idtabla1"> ID-Modificar: </label>
                <input class="campo_field" name="idTB2" type="text" placeholder="ID Tabla1" id="idTB2">
            </div>
